...
$(B)/custom-config: $(B)/.dpdk-patch.ok Makefile
	...
	$(call set,RTE_LIBRTE_MVPP2_PMD,$(DPDK_MVPP2_PMD))
	$(call set,RTE_LIBRTE_PMD_MVSAM_CRYPTO,$(DPDK_MVSAM_CRYPTO))
	$(call set,RTE_LIBRTE_PMD_NULL_CRYPTO,y)
	$(call set,RTE_LIBRTE_PMD_OPENSSL,y)
